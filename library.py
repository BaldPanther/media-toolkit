...
def _dash(m: re.Match) -> str:
    """Разделитель → дефис, пробелы вокруг — как в названии."""
...
def sanitize_name(name: str) -> str:
    ...
    Двоеточие и слэш становятся дефисом, а пробелы вокруг сохраняются такими
    же, как в названии, — этого хватает, чтобы разделитель читался правильно
    в обоих случаях:
