...
Всё это хранит сервер, а страница в браузере только показывает его — поэтому
её можно закрыть и открыть снова, хоть с другого компьютера, и увидеть то же,
что было: просканированные серии, найденные тайминги, ход операции.
